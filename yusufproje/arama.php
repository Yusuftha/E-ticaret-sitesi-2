					...
					<nav class="main-menu">
						...
						if ($_POST)
								...
								
								{
									...
									{
										?>
											<h3 style="color:red; text-align:center;">Lütfen boş bırakmayın</h3>
										<?php
									}
									else
									{
										$v = $veritabani->prepare("SELECT * FROM urunler WHERE urunbaslik LIKE ?");
										$v->execute(array("%".$ara."%"));
									...
									<?php	
										if ($xx)
										{
											...
											echo "<div style='font-size:22px;color:green;text-align:center;'>Aramanızla İlgili ".$xx." Sonuç Bulundu</div>";
													foreach ($x as $m)
													{
														?>
																...
																<a href="?do=1">
																	<div class="col-md-3 text-center uruncerceve" style="font-size: 13px;line-height:30px">
																		<img src="img/<?php echo $m["foto"].'.jpeg'; ?>" class="img-responsive" style="width: 150px;height: 150px;margin: 0px auto">
																			<?php 
										...
										else
										{
											...
											echo "<div style='font-size:22px;color:red;text-align:center;'>Aramanızla ilgili hiç sonuç bulunamadı.</div>";
