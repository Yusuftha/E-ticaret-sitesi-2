...
<body style="font-family: Oswald;">
	...
	<div class="container-fluid">
		...
		<div class="row" style="text-align: center">
			<img src="img/anasayfa2.jpg" class="img-responsive" style="position: relative;width: 100%">
			<div style="width: 100px;margin:0px auto;padding-right: 55px">
		...
		<div class="row">
			...
			<div class="col-md-10">
				<div class="row">
					<div class="col-md-4">
				<img src="img/genel.jpg" class="img-responsive">
				<div style="background-color:  #8c8c8c;height: 285px"><br>
					<h4 align="center" style="color:white">Bire bir çalışma</h4>
					<p align="justify" style="padding: 10px;color:white;font-size: 17px">
						Fitness dalında bir eğitmen ile çalışmanın önemi çok büyüktür. Fitkal.com dan satın aldığınız paketlerde bire bir eğitmenler ile çalışabilir ve başarı oranınızı ikiye katlayabilirsiz.	
					</p>
					<br>
				</div>
			</div>
			...
			<div class="col-md-4">
				<img src="img/genel2.jpg" class="img-responsive">

				<div style="background-color: #cc0000;height: 285px"><br>
					<h4 align="center" style="color:white">Yağ Yakma</h4>
					<p align="justify" style="padding: 10px;color:white;font-size: 17px">
						Yağ yakmak fitness dalında emek verilmesi gereken işlerden birisidir. Yağ yakmada beslenme programı büyük rol oynar. Eğer başarılı bir şekilde kilo vermek istiyorsanız kalori açığı yapmanız gerekir. Daha fazlası Fitkal.com "Yağ Yakımı" Antrenman Programında...					
					</p>
					<br>
				</div>
			...
			<div class="col-md-4">
				...
				<div style="background-color:  #8c8c8c;height: 285px"><br>
					<h4 align="center" style="color:white">Vücüt Geliştirme</h4>
					<p align="justify" style="padding: 10px;color:white;font-size: 17px">
						Vücut gelişimi fitness dalının bel kemiğidir. Her bireyin vücut tipi vardır, buna uygun beslenme programları ve antrenman rutinleri ile sporunu yapması gerekir. Siz de vücut tipinizi öğrenmek için Fitkal.com "Vücut Tipi Hesapla" üzerinden kendi vücut tipinizi öğrenerek antrenman programlarını ona göre satın alıp sporunuzu yapabilirsiz...					
					</p>
					<br>
				</div>
			</div>
	...
	<div class="area"></div><nav class="main-menu">
		...
		<div class="row" style="background-color: #333333;padding-left: 10px">
			<div class="col-md-6" style="color: white;">
				<h3 style="margin-bottom: 15px;padding: 20px">Kendine En Uygun Programı Bulmak İçin Butona Tıkla</h3>
				<p style="text-align: justify;font-size: 17px;padding: 20px">
					Vücut kitle indeksini hesaplayarak kendine en uygun antrenman programını bul ve antrenmana hemen başla. Vücut kitle indeksi hesaplama (İngilizce BMI), boyumuza göre kilomuzun zayıf mı, şişman mı olduğunu belirlemek için kullanılır. Bu makalede ayrıca ideal vücut ölçülerinize ulaşmanız için size en uygun antrenman programına da ulaşabileceksiniz!<br><br>
					<a href="vki.php" id="buton"> Başlayalım</a>
				</p>
			...
			<div class="col-md-6">
				<img src="img/gallery4.jpg" class="img-responsive" style="width: 540px;height: 350px">
			</div>
		</div>
		<br><br><br><br>
