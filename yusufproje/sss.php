...
<body style="font-family: Oswald;">
	<div class="container-fluid">
		...
		<div class="row">
			<p style="text-align: center;font-size: 60px">Sıkça Sorulan Sorular (S.S.S)</p>
			<div class="col-md-3">
				<h1>Linkler</h1>
				<br><br>
			...
			<div class="col-md-9" style="background-color: #e6e6e6;" align="left">
				<div class="row" style="padding: 10px">
					<div>
						<h4>FİTKAL.COM güvenilir mi?</h4>
						<p>
							Fitkal.com, 2012 yılından bu yana insanlara spor bilincini aşılamaya çalışan bir web sitesidir. Birçok hizmetleri ile ileri gelen web sitelerinden birisi olmuştur.
						</p>
						<br><br>
						<h4>Satın alınan programı geri iade edebilir miyim?</h4>
						<p>
							Fitkal.com'dan satın aldığınız programları eğer beğenmez ve memnun kalmazsanız onbeş (15) gün içerisinde cayma hakkınızı kullanarak iade edebilirsiniz.
						</p>
						<br><br>
						<h4>Satılan ürünler güvenilir mi?</h4>
						<p>
							Satılan tüm supplementler (takviye besin) kaliteli ve uzmanlar tarafından test edilip satışa sunulan ürünlerdir.
						</p>
						<br><br>
						<h4>Üye olmak ücretsiz mi?</h4>
						<p>
							Sitemize üye olmak ve sitemizdeki hesaplama araçlarını kullanmak tamamen ücretsizdir.
						</p>
					</div>
				</div>
